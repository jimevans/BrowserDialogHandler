// <copyright file="NativeDialogDismissedEventArgs.cs" company="BrowserDialogHandler Project">
...
{
    /// <summary>
    /// The <see cref="EventArgs"/> object returned when a dialog is dismissed.
    /// </summary>
    public class NativeDialogDismissedEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// Gets the <see cref="INativeDialog"/> that was dismissed.
        /// </summary>

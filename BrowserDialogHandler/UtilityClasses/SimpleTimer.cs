// <copyright file="SimpleTimer.cs" company="BrowserDialogHandler Project">
...
namespace BrowserDialogHandler.UtilityClasses
{
    ...
    public class SimpleTimer
    {
        ...
        public bool Elapsed
        {
            get { return this.stopwatch.Elapsed >= this.timeout; }
        }

        /// <summary>
        /// Gets the amount of time after which this timer times out. The time out can only be

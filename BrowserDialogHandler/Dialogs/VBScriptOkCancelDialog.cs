// <copyright file="VBScriptOkCancelDialog.cs" company="BrowserDialogHandler Project">
...
{
    /// <summary>
    /// Represents a VBScript dialog with OK and Cancel buttons.
    /// </summary>
    [Handleable(NativeDialogConstants.VBScriptOKCancelDialog)]
    public class VBScriptOkCancelDialog : VBScriptOkOnlyDialog
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VBScriptOkCancelDialog"/> class.
        /// </summary>
